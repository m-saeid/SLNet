...
from utils.cls_scanobject_util import *
...
def main():
    ...
    shutil.copy('tasks/cls_scanobject.py', f'{code_dir}/cls_scanobject.py')
    ...
    train_loader = DataLoader(ScanObjectNN(partition='training', num_points=args.n, out_d=args.embed_dim),
                              num_workers=args.workers,
                              batch_size=args.batch_size, shuffle=True, drop_last=True)
    
    test_loader = DataLoader(ScanObjectNN(partition='test', num_points=args.n, out_d=args.embed_dim),
                             num_workers=args.workers,

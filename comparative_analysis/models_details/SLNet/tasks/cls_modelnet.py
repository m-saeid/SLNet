...
from utils.cls_modelnet_util import *
...
def main():
    ...
    shutil.copy('tasks/cls_modelnet.py', f'{code_dir}/cls_modelnet.py')
    ...
    train_loader = DataLoader(ModelNet40(partition='train', num_points=args.n, out_d=args.embed_dim),
                              num_workers=args.workers, batch_size=args.batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(ModelNet40(partition='test', num_points=args.n, out_d=args.embed_dim),

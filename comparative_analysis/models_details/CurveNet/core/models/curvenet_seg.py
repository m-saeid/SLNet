...
class CurveNet(nn.Module):
    ...
    def forward(self, xyz, l=None):
        ...
        l1_xyz, l1_points, _ = self.cic11(xyz, l0_points)
        l1_xyz, l1_points, _ = self.cic12(l1_xyz, l1_points)

        l2_xyz, l2_points, _ = self.cic21(l1_xyz, l1_points)
        l2_xyz, l2_points, _ = self.cic22(l2_xyz, l2_points)

        l3_xyz, l3_points, _ = self.cic31(l2_xyz, l2_points)
        l3_xyz, l3_points, _ = self.cic32(l3_xyz, l3_points)
 
        l4_xyz, l4_points, _ = self.cic41(l3_xyz, l3_points)
        l4_xyz, l4_points, _ = self.cic42(l4_xyz, l4_points)

        l5_xyz, l5_points, _ = self.cic51(l4_xyz, l4_points)
        l5_xyz, l5_points, _ = self.cic52(l5_xyz, l5_points)
        l5_xyz, l5_points, _ = self.cic53(l5_xyz, l5_points)
        ...
        l4_xyz, l4_points, _ = self.up_cic5(l4_xyz, l4_points)

        l3_points = self.fp3(l3_xyz, l4_xyz, l3_points, l4_points)
        l3_xyz, l3_points, _ = self.up_cic4(l3_xyz, l3_points)

        l2_points = self.fp2(l2_xyz, l3_xyz, l2_points, l3_points)
        l2_xyz, l2_points, _ = self.up_cic3(l2_xyz, l2_points)
        ...
        xyz, x, _ = self.up_cic2(l1_xyz, x)
        xyz, x, _ = self.up_cic1(xyz, x)

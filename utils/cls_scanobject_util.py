...
class Classification(nn.Module):
    ...
    def forward(self, xyz, feature):
        xyz_list, f_list = self.encoder(xyz, feature)
...
def parse_args():
    ...
    parser.add_argument('--num_blocks1', type=str, default='1-1-3-1', help='num_blocks1')
    ...
    parser.add_argument('--classifier_mode', type=str, default='mlp_very_small', help='classifier_mode')
